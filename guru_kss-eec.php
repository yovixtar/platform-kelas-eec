...
<html>
<head>
	<title>Teacher Page | EE Class</title>
	<meta charset="utf-8">
...
<a href="?" style="color: red;text-decoration: none" ><h1>Teacher Page</h1></a>
<br />
...
switch ($sw_page) {
	case 'addassignment':
		include 'app/guru/add_assignment.php';
		break;
	case 'listassignment':
		include 'app/guru/list_assignment.php';
		break;
	case 'viewassignment':
		include 'app/guru/view_assignment.php';
		break;
	case 'addpoint':
		include 'app/guru/add_point.php';
		break;
	case 'editpoint':
		include 'app/guru/edit_point.php';
		break;
	
	default:
		include 'app/guru/default.php';
		break;
}
?>
<br />
